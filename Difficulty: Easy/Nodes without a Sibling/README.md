...
<span style="font-size: 18px;"><strong>Output: </strong>[</span><span style="font-size: 18px;">13 ,40]
<strong>Explanation: </strong>Nodes 13 and 40 dont have any siblings.</span></pre>
