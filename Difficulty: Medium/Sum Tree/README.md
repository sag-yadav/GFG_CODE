<h2><a href="https://www.geeksforgeeks.org/problems/sum-tree/1?page=1&category=Java,Tree&sortBy=submissions">Sum Tree</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><div class="entry-content">
