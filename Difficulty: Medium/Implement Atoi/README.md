<h2><a href="https://www.geeksforgeeks.org/problems/implement-atoi/1?page=1&category=Strings,Java&sortBy=submissions">Implement Atoi</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string <strong>s</strong>, the objective is to <strong>convert</strong> it into <strong>integer format</strong> without utilizing any built-in functions. Refer the below steps to know about <strong>atoi()</strong> function.</span></p>
...
Explanation:</strong><span style="font-size: 18px;"> After ignoring leading zeros n</span></span><span style="font-size: 18px;">othing is read after -12 as a non-digit character ‘g’ was encountered.</span></pre>
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 ≤ |s| ≤ 17</span></p></div><p><span style=font-size:18px><strong>Company Tags : </strong><br><code>Morgan Stanley</code>&nbsp;<code>Amazon</code>&nbsp;<code>Microsoft</code>&nbsp;<code>Payu</code>&nbsp;<code>Adobe</code>&nbsp;<code>Code Brew</code>&nbsp;<br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Strings</code>&nbsp;<code>Design-Pattern</code>&nbsp;<code>Data Structures</code>&nbsp;