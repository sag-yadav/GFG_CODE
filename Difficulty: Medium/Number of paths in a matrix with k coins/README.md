<h2><a href="https://www.geeksforgeeks.org/problems/number-of-paths-in-a-matrix-with-k-coins2728/1?page=4&category=Java,Recursion&sortBy=submissions">Number of paths in a matrix with k coins</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">You are given a matrix <strong>mat[][]</strong> of size <strong>n x m</strong>, where each of its cells contains some coins. <strong>Count </strong>the number of ways to collect <strong>exactly k coins</strong> while moving from the top left cell of the matrix to the bottom right cell. <br></span><span style="font-size: 14pt;">From a cell (<strong>i</strong>, <strong>j</strong>), you can only move to cell (<strong>i+1</strong>, <strong>j</strong>) or (<strong>i</strong>, <strong>j+1</strong>).</span></p>
